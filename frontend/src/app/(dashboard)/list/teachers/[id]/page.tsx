            ...
            <div className="w-full xl:w-2/3">
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
                        <div className="w-1/3">
                            <Image
                                src="https://images.pexels.com/photos/31670063/pexels-photo-31670063/free-photo-of-portrait-of-a-thoughtful-young-adult-in-white-shirt.png?auto=compress&cs=tinysrgb&w=600"
